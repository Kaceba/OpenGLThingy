...
namespace test {
		...
		m_TranslationA(-400, 0, 0), m_TranslationB(400, 0, 0)
	{
		...
		m_Shader->Bind();
		m_Shader->SetUniform4f("u_Color", 0.8f, 0.9f, 1.0f, 1.0f);
		m_Texture = std::make_unique<Texture>("res/textures/eula.png");
	...
	{
		ImGui::SliderFloat2("Translation1", &m_TranslationA.x, -800.0f, 800.0f);
		ImGui::SliderFloat2("Translation2", &m_TranslationB.x, -800.0f, 800.0f);
